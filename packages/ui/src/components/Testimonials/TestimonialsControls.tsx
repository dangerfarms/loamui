...
export interface TestimonialsControlsProps extends HTMLAttributes<HTMLDivElement> {
 ...
 * `Testimonials.Root` with. Place them anywhere inside the Root.
 */
