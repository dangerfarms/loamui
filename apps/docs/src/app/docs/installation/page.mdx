...
<div className={prose.callout}>
  ...
  <code> @layer</code> order, the LoamUI layers are named <code>loamui.tokens</code>,{" "}
  <code>loamui.elements</code> and <code>loamui.components</code>; keep <code>brand</code> after them.
</div>
