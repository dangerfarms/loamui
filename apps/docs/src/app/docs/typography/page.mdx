...
<div className="block">
  <div style={stage}>
    <p
      style={{
        fontSize: "var(--loam-text-3xl)",
        margin: 0,
        fontFamily: "var(--loam-font-display)",
      }}
    >
      {"Display"}
    </p>
    <p style={{ fontSize: "var(--loam-text-xl)", margin: 0 }}>{"Heading"}</p>
    <p style={{ fontSize: "var(--loam-text-md)", margin: 0 }}>
      {"Body copy sits at the base step."}
    </p>
...
<div className="block">
  <div style={stage}>
    <h2 style={{ fontVariantCaps: "small-caps", marginBlockStart: 0 }}>
      {"The harvest comes early"}
    </h2>
    <p
      style={{
        color: "var(--loam-color-fg-muted)",
