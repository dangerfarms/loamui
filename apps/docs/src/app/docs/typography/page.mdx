...
<div className={prose.block}>
  <div style={stage}>
    <p style={{ fontSize: "var(--loam-text-3xl)", margin: 0, fontFamily: "var(--loam-font-display)" }}>
      {"Display"}
    </p>
    <p style={{ fontSize: "var(--loam-text-xl)", margin: 0 }}>{"Heading"}</p>
    <p style={{ fontSize: "var(--loam-text-md)", margin: 0 }}>{"Body copy sits at the base step."}</p>
    <p style={{ fontSize: "var(--loam-text-sm)", margin: 0, color: "var(--loam-color-fg-muted)" }}>
...
<div className={prose.block}>
  <div style={stage}>
    ...
    <p style={{ color: "var(--loam-color-fg-muted)", fontSize: "var(--loam-text-sm)", marginBlock: 0 }}>
      {"By a staff reporter"}
    </p>
