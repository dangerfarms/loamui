...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "A description list under a heading that names it: each line is a term and its amount, the note is a second description of the delivery line, and the total is one more row rather than a different element.",
    modern:
      "Every row is a subgrid of the list, so the amounts share a column and stack on their decimal; the total's weight and heavier rule are one nested rule on the row.",
    composition:
