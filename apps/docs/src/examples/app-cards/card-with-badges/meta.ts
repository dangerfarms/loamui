...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "The Card is an article named by its heading; the badges and the amenities are lists, each named for what it lists, so a reader can jump to On site and hear five items.",
    modern:
      "The amenities are an auto-fill grid over a minimum width, so a narrow Card stacks them and a wide one runs them across; the icons are sized in em to the text beside them.",
    composition:
