...
export const meta: ExampleMeta = {
  ...
  notes: {
    ...
    modern:
      "No stylesheet of its own: every mark's position is one custom property core sets on it, placed by the thumb's own geometry in em, so the labels stay under their values at every container width and text size.",
    composition:
