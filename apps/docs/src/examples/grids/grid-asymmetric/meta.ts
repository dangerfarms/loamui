...
export const meta: ExampleMeta = {
  ...
  notes: {
    ...
    modern:
      "The list is the container and the grid: two columns at 2:1 from 44rem of its own width with the lead spanning both rows, so the stacked pair's height is the lead's, and one column in source order below that.",
    composition:
    ...
    accessible:
      "The photograph carries real alt text because a picture of the bench is what the lead is about; the actions are links because each goes somewhere, and every card's action sits at its foot so the eye finds it in the same place three times.",
  },
