...
export const meta: ExampleMeta = {
  ...
  notes: {
    ...
    modern:
      "A measuring wrapper contains the figure so fluid tokens resolve locally. Both images and the bounded divider share a grid cell. Layered scoped CSS clips the second treatment using a state-driven property, with mutually exclusive LTR and RTL rules.",
    composition:
