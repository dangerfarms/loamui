...
export const meta: ExampleMeta = {
  ...
  notes: {
    ...
    modern:
      "A two-column grid, the box floored at zero and the Button at its own width: both take the derived control height, so the row lines up with no measuring, and the icon is sized in em from the Button's type.",
    composition:
