...
export const meta: ExampleMeta = {
  ...
  notes: {
    ...
    modern:
      "Checked is detected from the input with :has(), never declared on the card: an outline in the Card's own line's place, and a focus ring around the card when the radio inside has keyboard focus.",
    composition:
    ...
    context:
      "The checked edge uses the -strong primary so it holds 3:1 in both schemes, and moves to the system Highlight in forced colours where a painted edge would be dropped.",
    accessible:
