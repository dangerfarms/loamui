...
export const meta: ExampleMeta = {
  ...
  notes: {
    ...
    modern:
      "The row is a two-track grid with the select's track sized to its content; the symbol in the box is one span that changes with the select, so no width is reserved for the widest currency.",
    composition:
