...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "A real <label for> on a real input: the words are the control's name in every state, and clicking them focuses the box. The placeholder is one space, there only so :placeholder-shown answers whether the box is empty; no hint is hidden in it.",
    modern:
      "The two positions are one :has() on the field, input:focus or input:not(:placeholder-shown), with no script watching the value; the rise is a transition on inset and font-size behind prefers-reduced-motion.",
    composition:
