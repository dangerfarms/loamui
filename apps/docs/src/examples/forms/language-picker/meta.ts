...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "Each name carries its language's lang attribute, so a screen reader switches voice to say Cymraeg as Welsh and Deutsch as German; the codes are ISO 639-1 text, not flags, since a flag names a country and a language crosses several.",
    modern:
      "The code glyph's scope is rooted at the glyph itself, once for the trigger and every item, cut in currentcolor so it follows the Button's channel and the item's highlight; forced colours give it an edge in place of the tint.",
    composition:
