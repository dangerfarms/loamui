...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "The same figure and iframe as the video, with a src that happens to be a map; the title says what the map shows, since that is the only name the frame has.",
    modern:
      "A 4 / 3 aspect-ratio on the frame, because a map reads better squarer than a video; nothing else changes between the two embeds.",
    composition:
