...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "Every thumbnail is an a whose href is the full-size file, so the gallery works before hydration and a modified click still opens a new tab; the lightbox is a native dialog with its backdrop, Escape and focus restore.",
    modern:
      "An auto-fill grid of square, object-fit thumbnails answering its own width, and the Modal's width set through its public --loam-modal-size rather than a rule inside it.",
    composition:
