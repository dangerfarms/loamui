...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "A figure whose quote is a blockquote and whose author is the figcaption, so the platform ties the attribution to the words rather than a layout implying it.",
    modern:
      "The blockquote drops the element style's rule and muted colour because here it is the main text, not an aside; everything else is the figure's gap.",
    composition:
