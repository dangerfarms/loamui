...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "A section named by its h2, so the close of the page is a landmark a screen reader can jump to, not a styled div.",
    modern:
      "The surface is the subtle background token with the large radius, and the words are centred by the grid, so nothing here is a colour or a size of the section's own.",
    composition:
