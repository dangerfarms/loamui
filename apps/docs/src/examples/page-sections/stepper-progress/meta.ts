...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "The order lives in an ol, so a screen reader announces 2 of 4 from the list itself; the placed date is a time element with its machine-readable value.",
    modern:
      "The Stepper stacks in a narrow container and runs as a row where it has 40rem, decided by its own width; the example adds only the spacing between header, steps and the way back.",
    composition:
    ...
    context:
      "One aria-current=step on the step reached is the whole state: the stylesheet reads done, current and upcoming from it, and it is also what assistive technology announces.",
    accessible:
