...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "The items are links, because each creates something on its own page; the popup is a native popover in the top layer with light dismiss and Escape, anchored to the button where the browser has anchor positioning.",
    modern:
