...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "The email is a mailto: link and the phone a tel: link, so a tap opens the mail app or the dialler; the two are a description list whose terms, Email and Phone, are read but not seen.",
    modern:
      "The role is written after the name, so a heading comes first, and moved above it by order in the grid; a long address wraps anywhere inside a cell floored at zero rather than widening the column.",
    composition:
