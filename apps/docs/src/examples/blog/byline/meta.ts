...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "The author's name sits in an address element, which HTML reserves for the contact information of an article's author, around a link with rel=\"author\"; the dates are time elements.",
    modern:
      "The dots between the parts are generated content drawn before every span that follows the address, so the parts can be reordered or dropped and the dots still fall only between them.",
    composition:
