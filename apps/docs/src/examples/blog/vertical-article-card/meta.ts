...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      'The Card is an article named by its heading, the author sits in an address with rel="author", and the date is a time with a machine-readable dateTime.',
    modern:
      "The picture is held to a portrait ratio so a column of these cards lines up whatever the files' shapes; the card caps its own width and a grid of them sets the columns.",
    composition:
