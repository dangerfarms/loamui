...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "The body is ordinary HTML, a paragraph with a link and a strong, then a ul, so the element styles dress it and a reader's tools see a link and a list, not a run of styled spans.",
    modern:
      "The example writes no rule for the link, the bold text or the bullets: the element layer already has them, and this scope only spaces the blocks inside the reading measure.",
    composition:
