...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "A real table with a caption, column headers and a row header per variety; each rating is a Rating in display mode, one named picture of the value rather than five decorative stars, and each share is a native meter.",
    modern:
      "The split cell is a three-column grid with both figures at fixed widths in tabular numerals and the Meter filling the middle track, so the bars line up down the column without a rule on the Meter.",
    composition:
