...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "A real table with a caption and row headers; the header sticks with position: sticky on the header cells themselves, which is what the platform provides and what Table's stickyHeader asks of it, so nothing is cloned or measured.",
    modern:
      "The cap is Table's public --loam-table-block-size, one custom property declared on the Table from the example's scope; the header's surface and its edge are Table's own, so the example paints nothing.",
    composition:
