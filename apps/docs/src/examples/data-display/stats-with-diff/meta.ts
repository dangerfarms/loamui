...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "Each tile is a description list: the label is the term, the figure and its change are descriptions; the sales figure is a data element whose value is the number.",
    modern:
      "The row is an auto-fit grid answering its own width; the figures and the percentages are set in tabular lining numerals so the tiles line up.",
    composition:
    ...
    context:
      "The direction's colour is the success or danger text token on the glyph and the figure, so it holds contrast in both schemes; a region could re-answer it, but the direction is data, not the region's status.",
    accessible:
