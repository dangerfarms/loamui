...
export const meta: ExampleMeta = {
  ...
  notes: {
    native:
      "The Card is a section named by its heading, and the three figures are one description list: each term has its figure, its sentence and its comparison as descriptions.",
    modern:
      "The Card is a container: stacked with a line above each figure where it is narrow, a row divided by lines where it is wide, with the end insets dropped so the row sits flush.",
    composition:
