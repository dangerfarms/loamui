...
- **Modern CSS.** A local inline-size container resolves the body’s fluid tokens. The statistics use an intrinsic grid that can wrap as available space changes. Avatar size comes from the public --loam-avatar-size hook.
